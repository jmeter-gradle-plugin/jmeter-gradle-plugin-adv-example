...
To use snapshot, use this repo: ```url 'http://oss.jfrog.org/artifactory/oss-snapshot-local'``` and this dependency: ```classpath "net.foragerr.jmeter:jmeter-gradle-plugin:+"```
